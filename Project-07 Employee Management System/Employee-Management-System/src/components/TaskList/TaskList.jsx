...
const TaskList = ({data}) => {
    return (
        <div id='tasklist' className='flex items-center justify-start gap-5 flex-nowrap h-[55%] w-full py-5 mt-10 rounded-2xl overflow-auto'>
            ...
            <div className='flex-shrink-0 h-full p-5 w-[450px] bg-green-600 rounded-xl'>
                <div className='flex justify-between items-center'>
                    <h3 className='bg-red-600 px-3 py-1 rounded text-sm font-semibold'>High</h3>
                    <h4 className='text-lg font-bold'>29 July 2024</h4>
                </div>
            ...
            <div className='flex-shrink-0 h-full p-5 w-[450px] bg-blue-600 rounded-xl'>
                <div className='flex justify-between items-center'>
                    <h3 className='bg-red-600 px-3 py-1 rounded text-sm font-semibold'>High</h3>
                    <h4 className='text-lg font-bold'>29 July 2024</h4>
                </div>
            ...
            <div className='flex-shrink-0 h-full p-5 w-[450px] bg-red-400 rounded-xl'>
                <div className='flex justify-between items-center'>
                    <h3 className='bg-red-600 px-3 py-1 rounded text-sm font-semibold'>High</h3>
                    <h4 className='text-lg font-bold'>29 July 2024</h4>
                </div>
