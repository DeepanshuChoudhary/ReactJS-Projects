    ...
    return (
        <div className='flex-shrink-0 h-full p-5 w-[450px] bg-yellow-600 rounded-xl'>
                ...
                <div className='flex justify-between mt-5'>
                    <button className='bg-green-700 py-1 px-2 text-sm rounded-lg w-full mr-0.5'>Mark as Completed</button>
                    <button className='bg-red-500 py-1 px-2 text-sm rounded-lg w-full ml-0.5'>Mark as Failed</button>
                </div>
            </div>
    )
}
